...
if (!empty($_REQUEST["ELEMENT_CODE"])) {
    ...
    if (preg_match('#^/restaurants/([^/]+)/?$#', $_SERVER['REQUEST_URI'], $matches)) {
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "CACHE_TYPE" => "A",
        "CHECK_DATES" => "Y",
        "DETAIL_URL" => "/restaurants/#ELEMENT_CODE#/",
        ...
        "IBLOCK_URL" => "/restaurants/",
        "INCLUDE_IBLOCK_INTO_CHAIN" => "Y",
        "PROPERTY_CODE" => array(
            "ADDRESS", "PHONE", "OPEN_HOURS", "SITE", "EMAIL",
            "CUISINE", "PRICE_LEVEL", "FEATURES", "GALLERY",
            "COORDINATES", "TOP", "TYPE", "SOCIAL_NETWORKS"
        ),
        "SET_BROWSER_TITLE" => "Y",
        "SET_CANONICAL_URL" => "Y",
        "SET_LAST_MODIFIED" => "Y",
