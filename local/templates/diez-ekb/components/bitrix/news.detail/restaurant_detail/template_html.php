    ...
    <section class="section">
        <div class="container">
            <div class="breadcrumbs">
                ...
                <a href="#" class="breadcrumbs__link">Рестораны города</a>
                <p class="breadcrumbs__link">Ресторан Лайт</p>
            </div>
        </div>
    </section>
            ...
            <div class="hotel-page">
                <div class="hotel-page__info">
                    <div class="hotel-page__meta">
                        <div class="meta-info">
                            <p class="meta-info__text">Ресторан</p>
                            <div class="rating">
                    ...
                    <div class="hotel-page__detail">
                        <div class="hotel-page__about">
                            <h1 class="title title--small">Ресторан Лайт</h1>
                    ...
                    <div class="hotel-page__features">
                        <div class="hotel-page__feature">
                            <img src="/local/templates/diez-ekb/assets/images/icons/icon-wifi.svg" alt="">
                            <span>Wi-Fi</span>
                        </div>
                        <div class="hotel-page__feature">
                            <img src="/local/templates/diez-ekb/assets/images/icons/icon-parking.svg" alt="">
                            <span>Парковка</span>
                        </div>
                        <div class="hotel-page__feature">
                            <img src="/local/templates/diez-ekb/assets/images/icons/icon-fridge.svg" alt="">
                    ...
                    <div class="hotel-page__body">
                        <div class="hotel-page__editor">
                            <div class="editor editor--longrid">
                                <h2>Изысканная кухня и атмосфера</h2>
                                <p>
                                    Добро пожаловать в ресторан "Лайт" – ваш островок уюта и современного
                                    ...
                                    познакомиться с уральской столицей.
                                </p>
                            </div>
                        </div>
