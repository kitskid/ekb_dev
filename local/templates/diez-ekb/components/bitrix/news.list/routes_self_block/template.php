...
//                                $routeTypes = array();
//                                var_dump($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE"]);
//                                if (!empty($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE_ENUM"])) {
//                                    if (is_array($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE_ENUM"])) {
//                                        $routeTypes = $arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE_ENUM"];
//                                    } else {
//                                        $routeTypes = array($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE_ENUM"]);
//                                    }
//                                }
