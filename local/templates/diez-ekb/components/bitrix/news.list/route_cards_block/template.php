                                ...
                                if ($sectionsCache === null) {
                                    ...
                                    if (CModule::IncludeModule("iblock")) {
                                        ...
                                        while ($arSection = $rsSections->GetNext()) {
                                            $sectionsCache[$arSection["ID"]] = $arSection["NAME"];
                                        }
                                    }
                                }
...
//
//                                    if (is_array($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE"])) {
//                                        $sectionIds = $arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE"];
//                                    } else {
//                                        $sectionIds = array($arItem["PROPERTIES"]["TYPE_TOURISM"]["VALUE"]);
//                                    }
//
//                                    foreach ($sectionIds as $sectionId) {
//                                        if (!empty($sectionId) && isset($sectionsCache[$sectionId])) {
//                                            $routeTypes[] = $sectionsCache[$sectionId];
//                                        }
//                                    }
//                                }
...
<!--                                        --><?php //if((!empty($routeTypes) && $arParams["DISPLAY_ROUTE_TYPE"] !== "N") || $routeDuration || $routeDistance): ?>
<!--                                            <div class="article-intro-card__tags">-->
<!--                                                --><?php //if(!empty($routeTypes) && $arParams["DISPLAY_ROUTE_TYPE"] !== "N"): ?>
<!--                                                    --><?php //foreach($routeTypes as $routeType): ?>
