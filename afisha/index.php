...
<?php
// Обработка фильтра по разделу из ЧПУ
$sectionFilter = '';
if (!empty($_REQUEST["SECTION_CODE"])) {
    ...
    if ($arSection = $rsSection->GetNext()) {
        $sectionFilter = $arSection["NAME"];

        // Устанавливаем заголовок страницы
        $APPLICATION->SetTitle("Афиша событий: " . $arSection["NAME"] . " - Екатеринбург 300");
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "CACHE_TIME" => "3600",
        "CHECK_DATES" => "Y",
        "SECTION_FILTER" => $sectionFilter // Передаем фильтр в компонент
    ),
    false
);
?>

<!-- Модальное окно для предложения события из index_ver_1.php -->
...
<!-- CSS и JS для модального окна из index_ver_1.php -->
<style>
